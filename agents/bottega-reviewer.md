...
Follow `$CLAUDE_PLUGIN_ROOT/skills/reviewing/SKILL.md` (this repo: `skills/reviewing/SKILL.md`) to the letter — it is your entire methodology and owns your report format. If you cannot load it, report that and stop; never improvise the methodology.
