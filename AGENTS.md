...
| `agents/` | Actor identity: builder, reviewer, qa, documenter, storyboarder, mechanic — agent files point at methodology, never copy it; no model or effort pins anywhere but the maestro's table, enforced by the route guard |
