...
Verify the shipped product the way a user would, independently of the builders and reviewers who produced it. Leave architecture out of scope and product code untouched, and return one verdict with its evidence per scenario.
