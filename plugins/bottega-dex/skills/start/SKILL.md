---
name: start
description: Prepare a Bottega Dex run by settling ownership and release intent, isolating its branch and worktree, loading repository commands, and confirming GitHub publication.
---

# Start

Prepare the run before any dispatch: owned, isolated, commands in hand, GitHub publication checked. Discovery and every later phase work inside what you start here.
